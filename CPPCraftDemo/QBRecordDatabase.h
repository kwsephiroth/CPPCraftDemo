...
public:
	...
	QBRecordCollection QBFindMatchingRecords(const std::string & columnName, const std::string& matchString);//Returns a collection subset containing matching records
